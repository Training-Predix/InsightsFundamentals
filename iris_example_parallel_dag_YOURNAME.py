...
insights_flow_name="iris_example_flow_YOURNAME"   # Replace YOURNAME with your name
dag_name="parallel_dag_YOURNAME"				  # Replace YOURNAME with your name
...
dag = DAG(dag_name, schedule_interval = "*/5 * * * *", catchup=False, default_args=default_args)
...
task_one = PredixInsightsOperator(
    ...
    predix_insights_flow_name=insights_flow_name,
    dag=dag)
